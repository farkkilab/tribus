...
global.gates[["Tumor cells"]] <- list(
  Pos=c('CK7','Ecadherin', 'HE4'),
  Neg=c('Desmin','CD68','CD3d','CD45RO','CD8a','CD4', 'CD20','CD57','CD11c','MHCII','CD11b','IBA1','CD207','CD163'))
global.gates[["Lymphoid cells"]] <- list(
  Pos=c('CD3d','CD45RO','CD8a','CD4', 'CD20','CD57'),
  Neg=c('CK7','Ecadherin','SMA', 'Mouse','Rabbit','Goat','CD31','HE4'))
global.gates[["Myeloid cells"]] <- list(
  Pos=c('CD11c','MHCII','CD11b','IBA1','CD207','CD163'),
  Neg=c('CK7','SMA','Mouse','Goat','Rabbit','CD31','Ecadherin','HE4'))
global.gates[["Stromal cells"]] <- list(
  Pos=c('Desmin','Vimentin','SMA','CD31'),
  Neg=c('CD163','CD3d','CD20','CD8a','CD15','CD11c','CD11b', 'Rabbit', 'Mouse', 'Goat','CK7','Ecadherin','HE4'))
